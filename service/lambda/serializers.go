...
func (m *awsRestjson1_serializeOpDeleteResourcePolicy) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	...
	opPath, opQuery := httpbinding.SplitURI("/2024-09-16/resource-policy/{ResourceArn}")
	request.URL.Path = smithyhttp.JoinPath(request.URL.Path, opPath)
	request.URL.RawQuery = smithyhttp.JoinRawQuery(request.URL.RawQuery, opQuery)
	request.Method = "DELETE"
	var restEncoder *httpbinding.Encoder
...
type awsRestjson1_serializeOpGetPublicAccessBlockConfig struct {
}

func (*awsRestjson1_serializeOpGetPublicAccessBlockConfig) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpGetPublicAccessBlockConfig) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	opPath, opQuery := httpbinding.SplitURI("/2024-09-16/public-access-block/{ResourceArn}")
	request.URL.Path = smithyhttp.JoinPath(request.URL.Path, opPath)
	request.URL.RawQuery = smithyhttp.JoinRawQuery(request.URL.RawQuery, opQuery)
	request.Method = "GET"
	var restEncoder *httpbinding.Encoder
	...
	if err := awsRestjson1_serializeOpHttpBindingsGetPublicAccessBlockConfigInput(input, restEncoder); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsGetPublicAccessBlockConfigInput(v *GetPublicAccessBlockConfigInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}
...
type awsRestjson1_serializeOpPutPublicAccessBlockConfig struct {
}

func (*awsRestjson1_serializeOpPutPublicAccessBlockConfig) ID() string {
	return "OperationSerializer"
}

func (m *awsRestjson1_serializeOpPutPublicAccessBlockConfig) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	out middleware.SerializeOutput, metadata middleware.Metadata, err error,
) {
	_, span := tracing.StartSpan(ctx, "OperationSerializer")
	endTimer := startMetricTimer(ctx, "client.call.serialization_duration")
	...
	if err := awsRestjson1_serializeOpHttpBindingsPutPublicAccessBlockConfigInput(input, restEncoder); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
	...
	jsonEncoder := smithyjson.NewEncoder()
	if err := awsRestjson1_serializeOpDocumentPutPublicAccessBlockConfigInput(input, jsonEncoder.Value); err != nil {
		return out, metadata, &smithy.SerializationError{Err: err}
	}
...
func awsRestjson1_serializeOpHttpBindingsPutPublicAccessBlockConfigInput(v *PutPublicAccessBlockConfigInput, encoder *httpbinding.Encoder) error {
	if v == nil {
		return fmt.Errorf("unsupported serialization of nil %T", v)
	}
...
func awsRestjson1_serializeOpDocumentPutPublicAccessBlockConfigInput(v *PutPublicAccessBlockConfigInput, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()

	if v.PublicAccessBlockConfig != nil {
		ok := object.Key("PublicAccessBlockConfig")
		if err := awsRestjson1_serializeDocumentPublicAccessBlockConfig(v.PublicAccessBlockConfig, ok); err != nil {
			return err
		}
	}
...
func awsRestjson1_serializeDocumentPublicAccessBlockConfig(v *types.PublicAccessBlockConfig, value smithyjson.Value) error {
	object := value.Object()
	defer object.Close()
	...
	if v.RestrictPublicResource != nil {
		ok := object.Key("RestrictPublicResource")
		ok.Boolean(*v.RestrictPublicResource)
	}
